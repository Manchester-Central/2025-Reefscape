...
public class Mech2DManager extends SubsystemBase {
  ...
  private final Color8Bit kInnerIntakeColor = new Color8Bit(0, 0, 255);
  ...
  public Mech2DManager(IdLift idLift, Intake intake) {
    ...
    m_intakeRoot = m_intakeBase.getRoot("Intake", 0.8, 0.2);
    m_innerIntakeLigament =
        m_intakeRoot.append(new MechanismLigament2d("InnerIntake", 0, 0, 8, kInnerIntakeColor));
    m_outerIntakeLigament =
        m_innerIntakeLigament.append(
            new MechanismLigament2d("OuterIntake", 0.2, 0, 10, kIntakeNeutralColor));
