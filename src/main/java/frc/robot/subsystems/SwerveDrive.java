...
public class SwerveDrive extends BaseSwerveDrive {
        ...
        private SwerveDrive(BaseSwerveModule[] swerveModules, SwerveConfigs swerveConfigs,
                        Supplier<Rotation2d> getRotation) throws Exception {
        ...
        public static SwerveDrive SeparateConstructor(Pigeon2 gyrPigeon2) throws Exception {
                ...
                SwerveModule2025 frontLeftSwerveModule = new SwerveModule2025("FL",
                                ...
                                new AbsoluteEncoderConfig(SwerveConstants.FLAbsoEncoCANID,
                                                SwerveConstants.FLInvertedEncoder,
                                                SwerveConstants.FLAngleEncoderOffset),
                                new DriveConfig(SwerveConstants.FLDriverRampRatePeriod,
                ...
                SwerveModule2025 frontRightSwerveModule = new SwerveModule2025("FR",
                                ...
                                new AbsoluteEncoderConfig(SwerveConstants.FRAbsoEncoCANID,
                                                SwerveConstants.FRInvertedEncoder,
                                                SwerveConstants.FRAngleEncoderOffset),
                                new DriveConfig(SwerveConstants.FRDriverRampRatePeriod,
                ...
                SwerveModule2025 backLeftSwerveModule = new SwerveModule2025("BL",
                                ...
                                new AbsoluteEncoderConfig(SwerveConstants.BLAbsoEncoCANID,
                                                SwerveConstants.BLInvertedEncoder,
                                                SwerveConstants.BLAngleEncoderOffset),
                                new DriveConfig(SwerveConstants.BLDriverRampRatePeriod,
                ...
                SwerveModule2025 backRightSwerveModule = new SwerveModule2025("BR",
                                ...
                                new AbsoluteEncoderConfig(SwerveConstants.BRAbsoEncoCANID,
                                                SwerveConstants.BRInvertedEncoder,
                                                SwerveConstants.BRAngleEncoderOffset),
                                new DriveConfig(SwerveConstants.BRDriverRampRatePeriod,
                                                SwerveConstants.BRAutonomousRampRatePeriod));
                SwerveModule2025[] swerveModule2025s = { frontLeftSwerveModule, frontRightSwerveModule,
                                backLeftSwerveModule,
                                backRightSwerveModule };
                SwerveDrive swerveDrive = new SwerveDrive(swerveModule2025s, swerveConfigs,
                                () -> gyrPigeon2.getRotation2d());
                return swerveDrive;

        }

        public void pathPlannerRobotRelative(ChassisSpeeds chassisSpeeds, DriveFeedforwards driveFeedforwards) {
