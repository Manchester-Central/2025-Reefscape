...
public final class Constants {
  ...
  public static class SwerveConstants {
    ...
    public static final LinearVelocity MaxFreeSpeedMPS = MetersPerSecond.of(4.1605);
    public static final AngularVelocity MaxRotationSpeedRadPS = RadiansPerSecond.of(12.0); // TODO: GET REAL
