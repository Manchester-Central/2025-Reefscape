...
public class DriverRelativeDrive extends Command {
  ...
  public void execute() {
    m_swerveDrive.moveFieldRelative(
        SwerveConstants.MaxFreeSpeedMPS.times(m_driver.getSlewLeftY()), 
        SwerveConstants.MaxFreeSpeedMPS.times(-m_driver.getSlewLeftX()), 
        SwerveConstants.MaxRotationSpeedRadPS.times(-m_driver.getSlewRightX()));
  }
